...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    images: [
      ...
      { url: FRONT_BLACK,                                                    alt: 'MASK OF STILLNESS — front logo' },
  ...
  },
  {
    ...
    images: [
      ...
      { url: FRONT_BLACK,                                              alt: 'THE GHOST — front logo' },
    ],
    accent:   '#cc2222',
    bg:       '#0c0c0c',
    label:    'DROP 001',
  ...
  },
  {
    ...
    images: [
      ...
      { url: FRONT_WHITE,                                                       alt: 'THE SENTINEL — front logo' },
    ],
    accent:   '#cc2222',
    bg:       '#15151a',
    label:    'DROP 001',
  ...
  },
  {
    ...
    price:    38,
    design:   '/designs/tengu-watch.png',
    images:   teeImages('crow-warrior-bloodmoon-dark', 'black', 'THE SENTINEL', ['back', 'm1', 'm3', 'm4']),
    accent:   '#cc2222',
    bg:       '#0f0f12',
    label:    'DROP 001',
    color:    'Black',
