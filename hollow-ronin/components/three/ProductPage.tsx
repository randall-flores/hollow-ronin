    ...
    <main style={{ minHeight: '100vh', background: '#080808', color: '#ffffff', display: 'flex', fontFamily: 'Georgia, Times New Roman, serif' }}>
      ...
      <div style={{ flex: 1, height: 'calc(100vh - 68px)', overflowY: 'auto', display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '48px 52px', gap: 30 }}>
        ...
        <div>
          ...
          <h1 style={{ margin: '0 0 6px', fontFamily: "'Bebas Neue', sans-serif", fontSize: 56, fontWeight: 400, lineHeight: 1, letterSpacing: '0.06em', color: '#f0ede6' }}>{product.name}</h1>
          <p style={{ margin: '0 0 18px', fontSize: 10, letterSpacing: 6, fontFamily: 'monospace', color: 'rgba(255,255,255,0.4)', textTransform: 'uppercase' }}>{product.subtitle}</p>
