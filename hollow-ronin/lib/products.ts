...
export const PRODUCTS: Product[] = [
  {
    ...
    images: teeImages('crow-ronin-bloodmoon', 'black', 'Torii Ronin Tee', ['back']),
    accent: '#cc2222',
    bg:     '#0f0a0a',
    label:  'DROP 001',
    color:  'Black',
  ...
  },
  {
    ...
    price:  38,
    design: '/designs/torii-ronin.png',
    images: teeImages('crow-ronin-bloodmoon', 'white', 'Torii Ronin Tee', ['back', 'm1', 'm3', 'm4']),
    accent: '#cc2222',
    bg:     '#15100f',
    label:  'DROP 001',
    color:  'White',
  ...
  },
  {
    ...
    images: [
      { url: '/mockups/tee-cyber-oni-portrait-circle-back-black-model3.png', alt: 'Hannya: Silence Tee — worn, studio' },
      { url: FRONT_BLACK,                                                    alt: 'Hannya: Silence Tee — front logo' },
      { url: '/mockups/tee-cyber-oni-portrait-circle-back-black-model4.png', alt: 'Hannya: Silence Tee — worn, editorial' },
    ],
    accent: '#a83244',
    bg:     '#0a0a0a',
    label:  'DROP 001',
  ...
  {
    slug:   'hollow-warrior-tee',
    name:   'The Hollow Warrior Tee',
    tag:    'The Bone Vow',
    price:  38,
    design: '/designs/hollow-warrior.png',
    images: teeImages('skeleton-samurai-kanji', 'black', 'The Hollow Warrior Tee', ['back', 'm1', 'm3', 'm4']),
    accent: '#cc2222',
    bg:     '#0a0a0a',
    label:  'DROP 001',
    color:  'Black',
  ...
  },
  {
    ...
    images: [
      { url: '/mockups/tee-crow-warrior-bloodmoon-dark-back-white-model4.png', alt: 'Tengu: Watch Tee — worn, editorial' },
      { url: FRONT_WHITE,                                                       alt: 'Tengu: Watch Tee — front logo' },
    ],
    accent: '#cc2222',
    bg:     '#15151a',
    label:  'DROP 001',
  ...
  {
    slug:   'tengu-watch-tee-black',
    name:   'Tengu: Watch Tee',
    tag:    'The Sentinel',
    price:  38,
    design: '/designs/tengu-watch.png',
    images: teeImages('crow-warrior-bloodmoon-dark', 'black', 'Tengu: Watch Tee', ['back', 'm1', 'm3', 'm4']),
    accent: '#cc2222',
    bg:     '#0f0f12',
    label:  'DROP 001',
    color:  'Black',
